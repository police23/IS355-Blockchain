...
OrderAssignment.belongsTo(User, {
...
// 2. Quan hệ với VoucherTypes (Quan trọng để fix lỗi controller)
// Lưu ý: "as: 'type'" phải khớp với code trong OrderController.js
UserVoucher.belongsTo(VoucherTypes, {
  foreignKey: "voucher_type_id",
  as: "type",
});
VoucherTypes.hasMany(UserVoucher, {
  foreignKey: "voucher_type_id",
  as: "userVouchers",
});
